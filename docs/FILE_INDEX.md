...
| [`app/src/main/res/layout/activity_main.xml`](file:///storage/emulated/0/projects/Android-PRoot-Engine/app/src/main/res/layout/activity_main.xml) | 现代化简洁界面布局，包含多语言切换栏、状态徽章、操作按钮组与控制台输出面板 |
