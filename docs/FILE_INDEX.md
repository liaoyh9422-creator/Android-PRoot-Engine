...
| [`app/src/main/res/mipmap-*/`](file:///storage/emulated/0/projects/Android-PRoot-Engine/app/src/main/res/) | **Android 8.0+ 自适应图标与旧版图标集**，通过 `mipmap-anydpi-v26` 配置纯黑底板（`#000000`）与前景 `ic_launcher_foreground`，彻底消除桌面白底白边 |
